...
export const MOCK_PATHWAY_STEPS = [
  {
    ...
    tags: [
      { text: '⏱ Start immediately', color: 'blue' },
      { text: '2 matching roles ready now', color: 'green' }
    ]
  },
  {
    number: 2,
    ...
    tags: [
      { text: '⏱ 6–18 months to enroll', color: 'blue' },
  ...
  },
  {
    ...
    tags: [
      { text: '⏱ Rolling opportunities', color: 'blue' },
