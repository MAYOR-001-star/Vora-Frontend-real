...
export const MOCK_MATCHED_ROLES: MatchedRoleListing[] = [
  {
    ...
    eligibilityRows: [
      ...
      { label: 'Visa sponsorship', value: 'Not sponsored — candidates must hold or obtain UK work authorisation', valueClassName: 'text-[#DC2626]' },
      { label: 'Right to work', value: 'Right to work in the UK is required before start date', valueClassName: 'text-[#0047CC]' },
  ...
  },
  {
    ...
    eligibilityRows: [
      ...
      { label: 'Visa sponsorship', value: 'Not applicable — no physical presence required', valueClassName: 'text-[#DC2626]' },
      { label: 'Right to work', value: 'No work permit required for remote engagement', valueClassName: 'text-[#0047CC]' },
  ...
  },
  {
    ...
    companyName: 'HealthReach Foundation',
    companyInitials: 'HRF',
    salaryAmount: '$900',
    salaryPeriod: 'monthly',
    matchPercent: 80,
    ...
    eligibility: {
      title: '✓ Eligibility verified — you qualify to work in this role',
      body: 'Your eligibility for this Nigeria-based role was confirmed. HealthReach Foundation actively welcomes international candidates and provides visa sponsorship and relocation support for shortlisted hires.',
    },
    ...
    aboutRole:
      'HealthReach Foundation is recruiting a Health Research Associate to support our Nigeria operations. You will be embedded within active field research programmes, contributing to data collection, community engagement, and impact reporting.',
    responsibilities: [
    ...
    eligibilityRows: [
      ...
      { label: 'Timezone', value: 'WAT (GMT+1)' },
      {
        label: 'International applicants',
        value:
          'HealthReach Foundation provides visa sponsorship for international candidates. Your eligibility for this role has been confirmed.',
      },
      { label: 'Visa sponsorship', value: 'Not sponsored — candidates must hold Nigerian work authorisation', valueClassName: 'text-[#DC2626]' },
      {
        label: 'Right to work',
