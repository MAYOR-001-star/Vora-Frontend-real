...
const ProfileWaitlistHero: React.FC<ProfileWaitlistHeroProps> = ({ summary }) => (
  <div className="bg-white border border-[#E6E6E6] rounded-[10px] px-5 sm:px-9 py-6 sm:py-9 text-center mb-[18px]">
    <div className="w-[68px] h-[68px] rounded-full bg-[#EBF6FF] border-2 border-[#387DFF] flex items-center justify-center mx-auto mb-5">
    ...
    <p className="text-sm text-[#808080] leading-relaxed max-w-[460px] mx-auto mb-5 sm:mb-[22px]">
    ...
    <div className="inline-flex items-start gap-2.5 bg-[#EBF6FF] border-[1.5px] border-[#387DFF] rounded-lg px-5 py-3 text-left mb-5 sm:mb-[22px]">
      <ShieldIcon size={18} strokeWidth={2.5} className="text-[#0047CC] shrink-0 mt-0.5" />
      <div>
        <p className="text-sm font-bold text-[#0047CC]">Strong profile detected</p>
        <p className="text-xs text-[#387DFF] mt-0.5">{summary.strongProfileNote}</p>
      </div>
    </div>
